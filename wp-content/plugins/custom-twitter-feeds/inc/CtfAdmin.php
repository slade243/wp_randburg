...
class CtfAdmin
{
    ...
    public function options_page_init()
    {
        ...
        register_setting(
            'ctf_configure', // name of the option that gets called in "get_option()"
            'ctf_configure', // matches the options name
            array( $this, 'validate_configure_options' ) // callback function to validate and clean data
        );

        add_settings_section(
            'ctf_configure_connect', // matches the section name
            'Configuration',
        ...
        $this->create_settings_field( array(
            ...
            'page' => 'ctf_configure_connect', // matches the section name
        ...
        add_settings_section(
            'ctf_configure_feed_settings', // matches the section name
            'Feed Settings',
        ...
        $this->create_settings_field( array(
            ...
            'page' => 'ctf_configure_feed_settings', // matches the section name
            'section' => 'ctf_configure_feed_settings', // matches the section name
            'option' => 'ctf_configure', // matches the options name
        ...
        register_setting(
            'ctf_customize', // name of the option that gets called in "get_option()"
            'ctf_customize', // matches the options name
            array( $this, 'validate_customize_options' ) // callback function to validate and clean data
        );

        add_settings_section(
            'ctf_customize_general', // matches the section name
            'General',
            array( $this, 'general_section_text' ), // callback function to explain the section
            'ctf_customize_general' // matches the section name
        );
        ...
        add_settings_section(
            'ctf_customize_date', // matches the section name
            'Date',
            array( $this, 'general_section_text' ), // callback function to explain the section
            'ctf_customize_date' // matches the section name
        );
        ...
        $this->create_settings_field( array(
            ...
            'page' => 'ctf_customize_date', // matches the section name
            'section' => 'ctf_customize_date', // matches the section name
            'option' => 'ctf_customize', // matches the options name
            'class' => 'default-text', // class for the wrapper and input field
        ...
        add_settings_section(
            'ctf_customize_links', // matches the section name
            'Links',
            array( $this, 'general_section_text' ), // callback function to explain the section
            'ctf_customize_links' // matches the section name
        );
        ...
        $this->create_settings_field( array(
            ...
            'callback'  => 'default_checkbox', // name of the function that outputs the html
            'page' => 'ctf_customize_links', // matches the section name
            'section' => 'ctf_customize_links', // matches the section name
            'option' => 'ctf_customize', // matches the options name
            'class' => '',
        ...
        add_settings_section(
            'ctf_customize_misc', // matches the section name
            'Misc',
            array( $this, 'general_section_text' ), // callback function to explain the section
            'ctf_customize_misc' // matches the section name
        );
        ...
        $this->create_settings_field( array(
            ...
            'page' => 'ctf_customize_misc', // matches the section name
            'section' => 'ctf_customize_misc', // matches the section name
            'option' => 'ctf_customize', // matches the options name
            'class' => 'default-text', // class for the wrapper and input field
        ...
        add_settings_section(
            'ctf_customize_advanced', // matches the section name
            'Advanced',
            array( $this, 'general_section_text' ), // callback function to explain the section
            'ctf_customize_advanced' // matches the section name
        );
        ...
        $this->create_settings_field( array(
            ...
            'page' => 'ctf_customize_advanced', // matches the section name
            'section' => 'ctf_customize_advanced', // matches the section name
            'option' => 'ctf_customize', // matches the options name
            'class' => 'default-text', // class for the wrapper and input field
            'fields' => array(
                1 => array( 'auto', 'Auto' ),
        ...
        register_setting(
            'ctf_style', // name of the option that gets called in "get_option()"
            'ctf_style', // matches the options name
            array( $this, 'validate_style_options' ) // callback function to validate and clean data
        );

        add_settings_section(
            'ctf_style_general', // matches the section name
            'General',
            array( $this, 'general_section_text' ), // callback function to explain the section
            'ctf_style_general' // matches the section name
        );
        ...
        $this->create_settings_field( array(
            ...
            'page' => 'ctf_style_general', // matches the section name
            'section' => 'ctf_style_general', // matches the section name
            'option' => 'ctf_style', // matches the options name
            'class' => '',
        ...
        add_settings_section(
            'ctf_style_header', // matches the section name
            'Header',
            array( $this, 'general_section_text' ), // callback function to explain the section
            'ctf_style_header' // matches the section name
        );
        ...
        $this->create_settings_field( array(
            ...
            'section' => 'ctf_style_header', // matches the section name
            'option' => 'ctf_style', // matches the options name
            'class' => 'default-text', // class for the wrapper and input field
        ...
        add_settings_section(
            'ctf_style_type', // matches the section name
            'Typography',
            array( $this, 'general_section_text' ), // callback function to explain the section
            'ctf_style_type' // matches the section name
        );
        ...
        $this->create_settings_field( array(
            ...
            'page' => 'ctf_style_type', // matches the section name
            'section' => 'ctf_style_type', // matches the section name
            'option' => 'ctf_style', // matches the options name
            'class' => 'default-text', // class for the wrapper and input field
        ));
        ...
        add_settings_section(
            'ctf_style_load', // matches the section name
            '"Load More" Button',
            array( $this, 'general_section_text' ), // callback function to explain the section
            'ctf_style_load' // matches the section name
        );
        ...
        $this->create_settings_field( array(
            ...
            'callback'  => 'default_color', // name of the function that outputs the html
            'page' => 'ctf_style_load', // matches the section name
            'section' => 'ctf_style_load', // matches the section name
            'option' => 'ctf_style', // matches the options name
            'class' => '',
    ...
    public function feed_settings_radio( $args )
    {
        ...
        $show_replies = ( isset( $options[ $args['name'].'_include_replies' ] ) ) ? $options[ $args['name'].'_include_replies' ] : false;
    ...
    public function validate_configure_options( $input )
    {
        $new_input = array();
        $feed_types = apply_filters( 'ctf_admin_feed_type_list', '' );
        $cron_clear_cache = isset( $input['cron_cache_clear'] ) ? $input['cron_cache_clear'] : 'no';
        $new_input['ajax_theme'] = false;
        $new_input['have_own_tokens'] = false;
        $new_input['use_own_consumer'] = false;
        $new_input['preserve_settings'] = false;

        foreach ( $input as $key => $val ) {
            if ( $key == 'search_text' || $key == 'usertimeline_text' ) {
                $new_input[$key] = apply_filters( 'ctf_admin_validate_' . $key, $val );
            } elseif ( in_array( $key, $feed_types ) ) {
                $new_input[$key] = apply_filters( 'ctf_admin_validate_include_replies', $val, $input['type'] );
        ...
        $new_input['include_replies'] = apply_filters( 'ctf_admin_set_include_replies', $new_input );
    ...
    public function validate_customize_options( $input )
    {
        $new_input = array();
        $cron_clear_cache = isset( $input['cron_cache_clear'] ) ? $input['cron_cache_clear'] : 'no';
    ...
    public function validate_style_options( $input )
    {
        $new_input = array();
